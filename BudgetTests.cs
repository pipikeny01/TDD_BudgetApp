...
namespace TDD_BudgetApp
{
    public class BudgetTests
    {
        ...
        [Test]
        public void Daily_Amount_is_30()
        {
            GivenBudgets(new Budget { YearMonth = "201004", Amount = 300 });
            TotalAmountShouldBe(30, new DateTime(2010, 4, 3), new DateTime(2010, 4, 5));
        }


        [Test]
        public void Two_Month_Daily_Amount_is_302()
        {
            GivenBudgets(
                new Budget { YearMonth = "201004", Amount = 300 } , 
                new Budget { YearMonth = "201006", Amount = 30 });
            TotalAmountShouldBe(302, new DateTime(2010, 4, 1), new DateTime(2010, 6, 2));
        }

        [Test]
        public void Three_Month_Daily_Amount_is_10()
        {
            GivenBudgets(
                new Budget { YearMonth = "201004", Amount = 300 },
                new Budget { YearMonth = "201006", Amount = 30 },
                new Budget { YearMonth = "201101", Amount = 31 });
            TotalAmountShouldBe(361, new DateTime(2010, 4, 1), new DateTime(2011, 3, 2));
        }
